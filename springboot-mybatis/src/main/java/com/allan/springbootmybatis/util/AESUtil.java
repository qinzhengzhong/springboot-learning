...
public class AESUtil {
	...
	private static final String encodeRules = "allan";
	...
	public static String AESDecode(String content) {
		try {
			...
			throw new RuntimeException("配置文件中的密码需要使用AES加密，请使用com.rs.common.util.AESUtil工具类修改这些值！");
			// e.printStackTrace();
		} catch (BadPaddingException e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) {
		String key = "123456";
		String content = AESEncode(key);
		System.out.println("加密后：" + content);
		System.out.println("解密后：" + AESDecode(content));
	}
